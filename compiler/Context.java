    ...
    public void C(int ruleNo)
    {
        ...
        switch(ruleNo)
        {
            ...
            case 2:
                ...
                // TODO: 
                if (isProcOrFunc) {
                    orderNumber = orderNumberStack.top();
                }
                break;
            case 3:
            ...
            case 22:
                ...
                if (currentBucket != null) {
                    ...
                    errorCount++;
                    System.err.println("\nProcess terminated.\nAt least " + (errorCount + parser.yylex.num_error) + " error(s) detected.");
                    System.exit(1);
                }
                break;
            case 23:
            ...
            case 24:
                // TODO: 
                Bucket procBucket = symbolHash.find(currentStr, lexicalLevel);
                if (procBucket != null) {
            ...
            case 29:
                ...
                if (procFuncBucket != null) {
                    if (procFuncBucket.getIdKind() == Bucket.PROCEDURE || procFuncBucket.getIdKind() == Bucket.FUNCTION) {
                        int paramCount = symbolHash.getParameterCount(currentStr);
                        if (paramCount > 0) {
                ...
                if (!argCountStack.isEmpty()) {
                    ...
                    if (procFunc != null) {
                        if (procFunc.getIdKind() == Bucket.PROCEDURE || procFunc.getIdKind() == Bucket.FUNCTION) {
                            int expectedArgs = symbolHash.getParameterCount(currentStr);
            ...
            case 37:
                ...
                if (bucket37 != null && bucket37.getIdKind() == Bucket.FUNCTION) {
                    ...
                    if (bucket37.getIdKind() != Bucket.FUNCTION) {
                        System.out.println("Semantic Error: '" + currentStr + "' is not a function at line " + currentLine);
                        errorCount++;
                    }
                } else {
